...
describe("Query", function () {
    ...
    test("generates query with alias", function () {
        var query = queryBuilder.query({
            operation: {
                name: "thoughts",
                alias: "myThoughts",
    ...
    test("generates queries with the same operation with different alias", function () {
        var query = queryBuilder.query([
            {
                operation: {
                    name: "thoughts",
    ...
    test("generates query when adapter and alias arguments are provided", function () {
        var query = queryBuilder.query({
            operation: {
                name: "thoughts",
                alias: "myThoughts",
    ...
    test("generates query arguments with inline fragment", function () {
        var query = queryBuilder.query({
            operation: "thought",
            fields: [
                "id",
    ...
    test("generates aliased nested queries", function () {
        var query = queryBuilder.query([
            {
...
describe("Mutation", function () {
    ...
    test("generates mutation query with alias", function () {
        var query = queryBuilder.mutation({
            operation: {
                name: "thoughtCreate",
    ...
    test("generates mutations with the same operation with different alias", function () {
        var query = queryBuilder.mutation([
            {
                operation: {
                    name: "thoughtCreate",
    ...
    test.only("generates mutation with operation name", function () {
        var query = queryBuilder.mutation([
            {
                operation: "thoughtCreate",
                variables: {
...
describe("Subscriptions", function () {
    ...
    test("generates subscriptions with query alias", function () {
        var query = queryBuilder.subscription([
            {
                operation: {
                    name: "thoughtCreate",
