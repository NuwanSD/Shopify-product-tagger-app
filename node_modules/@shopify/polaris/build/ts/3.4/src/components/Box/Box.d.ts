...
import { ColorTextAlias, ColorBackgroundAlias, ColorBorderAlias, BorderWidthScale, BorderRadiusScale, ShadowAlias, SpacingSpaceScale } from '@shopify/polaris-tokens';
