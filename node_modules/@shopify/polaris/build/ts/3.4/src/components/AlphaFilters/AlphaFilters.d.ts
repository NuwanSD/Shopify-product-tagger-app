...
import { AppliedFilterInterface, FilterInterface } from '../../types';
...
export declare function AlphaFilters({ queryValue, queryPlaceholder, focused, filters, appliedFilters, onQueryChange, onQueryClear, onQueryBlur, onQueryFocus, onClearAll, children, disabled, hideFilters, hideQueryField, disableQueryField, borderlessQueryField, loading, disableFilters, mountedState, }: AlphaFiltersProps): JSX.Element;
//# sourceMappingURL=AlphaFilters.d.ts.map
