...
import { AlphaFiltersProps } from '../AlphaFilters';
import { AlphaTabsProps } from '../AlphaTabs';
import { IndexFiltersPrimaryAction, IndexFiltersCancelAction, SortButtonChoice } from './types';
import { IndexFiltersMode } from './types';
export interface IndexFiltersProps extends Pick<AlphaFiltersProps, Exclude<keyof AlphaFiltersProps, 'focused' | 'children' | 'disableQueryField' | 'disableFilters'>>, Pick<AlphaTabsProps, 'tabs' | 'onSelect' | 'selected'> {
...
export declare function IndexFilters({ tabs, selected, onSelect, onSort, onSortKeyChange, onSortDirectionChange, sortOptions, sortSelected, queryValue, queryPlaceholder, primaryAction, cancelAction, filters, appliedFilters, onClearAll, onQueryChange, onQueryFocus, onQueryClear, onEditStart, disabled, disableQueryField, hideFilters, loading, mode, setMode, disableStickyMode, isFlushWhenSticky, canCreateNewView, onCreateNewView, filteringAccessibilityLabel, filteringAccessibilityTooltip, hideQueryField, }: IndexFiltersProps): JSX.Element;
