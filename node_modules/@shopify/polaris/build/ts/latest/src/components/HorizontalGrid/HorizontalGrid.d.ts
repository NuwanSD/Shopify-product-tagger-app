...
declare type Columns = ResponsiveProp<ColumnsType>;
declare type Gap = ResponsiveProp<SpacingSpaceScale>;
declare type HorizontalGridAlignItems = 'start' | 'end' | 'center';
...
export declare function HorizontalGrid({ children, columns, gap, alignItems, }: HorizontalGridProps): JSX.Element;
export {};
