...
export declare function MediaCard({ title, children, primaryAction, secondaryAction, description, popoverActions, portrait, size, onDismiss, }: MediaCardProps): JSX.Element;
export {};
