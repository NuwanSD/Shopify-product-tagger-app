...
function IndexTableBase({
  ...
  }, /*#__PURE__*/React__default["default"].createElement(LegacyStack.LegacyStack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  ...
  function renderHeadingContent(heading, index) {
    ...
    if (heading.new) {
      headingContent = /*#__PURE__*/React__default["default"].createElement(LegacyStack.LegacyStack, {
        wrap: false,
        alignment: "center"
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      const iconMarkup = /*#__PURE__*/React__default["default"].createElement("span", {
        className: css.classNames(IndexTable$1["default"].TableHeadingSortIcon, (heading === null || heading === void 0 ? void 0 : heading.alignment) === 'end' && IndexTable$1["default"]['TableHeadingSortIcon-heading-align-end'], isCurrentlySorted && IndexTable$1["default"]['TableHeadingSortIcon-visible'])
      ...
      const defaultSortButtonProps = {
        ...
        className: css.classNames(IndexTable$1["default"].TableHeadingSortButton, !isCurrentlySorted && (heading === null || heading === void 0 ? void 0 : heading.alignment) === 'end' && IndexTable$1["default"]['TableHeadingSortButton-heading-align-end'], isCurrentlySorted && (heading === null || heading === void 0 ? void 0 : heading.alignment) === 'end' && IndexTable$1["default"]['TableHeadingSortButton-heading-align-end-currently-sorted'], isPreviouslySorted && !isRenderAfterSelectEvent && (heading === null || heading === void 0 ? void 0 : heading.alignment) === 'end' && IndexTable$1["default"]['TableHeadingSortButton-heading-align-end-previously-sorted']),
        tabIndex: selectMode ? -1 : 0
      };
      const sortMarkup = /*#__PURE__*/React__default["default"].createElement(UnstyledButton.UnstyledButton, defaultSortButtonProps, iconMarkup, /*#__PURE__*/React__default["default"].createElement("span", {
      ...
      if (!heading.tooltipContent) {
        return (
          ...
          React__default["default"].createElement(Tooltip.Tooltip, Object.assign({}, defaultTooltipProps, {
      ...
      if (heading.tooltipContent) {
        return (
          ...
          React__default["default"].createElement("div", {
            className: IndexTable$1["default"].SortableTableHeadingWithCustomMarkup
          }, /*#__PURE__*/React__default["default"].createElement(UnstyledButton.UnstyledButton, defaultSortButtonProps, /*#__PURE__*/React__default["default"].createElement(Tooltip.Tooltip, defaultHeaderTooltipProps, /*#__PURE__*/React__default["default"].createElement("span", {
            className: IndexTable$1["default"].TableHeadingUnderline
          }, headingContent)), /*#__PURE__*/React__default["default"].createElement(Tooltip.Tooltip, Object.assign({}, defaultTooltipProps, {
            content: sortTooltipContent,
            preferredPosition: "above"
          }), iconMarkup)))
        );
    ...
    if (heading.tooltipContent) {
      return (
        ...
        React__default["default"].createElement(Tooltip.Tooltip, Object.assign({}, defaultHeaderTooltipProps, {
