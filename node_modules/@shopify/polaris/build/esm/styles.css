@charset "UTF-8";
:root { --polaris-version-number: '10.45.0'; }

html, body { font-size: var(--p-font-size-100); line-height: var(--p-font-line-height-2); font-weight: var(--p-font-weight-regular); text-transform: initial; letter-spacing: initial; font-weight: var(--p-font-weight-regular); color: var(--p-color-text); }
...
.Polaris-AlphaFilters-FilterPill__ToggleButton .Polaris-AlphaFilters-FilterPill__Label { display: flex; padding-left: var(--p-space-05); }
...
@media (max-width: 47.9975em) { .Polaris-AlphaFilters__FiltersWrapperWithAddButton { position: relative; }
  ...
  .Polaris-AlphaFilters__AddFilterActivatorMultiple { position: sticky; z-index: var(--p-z-index-1); top: 0; right: 0; display: flex; padding: var(--p-space-1) var(--p-space-4) var(--p-space-1) 0; background: var(--p-color-bg); margin-left: var(--p-space-2); }
...
@media (max-width: 47.9975em) { .Polaris-AlphaFilters__ClearAll { margin-left: var(--p-space-2); padding-right: var(--p-space-4); }
  .Polaris-AlphaFilters__MultiplePinnedFilterClearAll { transform: translateX(-0.5rem); position: relative; z-index: var(--p-z-index-1); margin-left: 0; padding-right: var(--p-space-4); } }
...
.Polaris-AlphaTabs__Tab:not([aria-disabled='true']):active { background-color: var(--p-color-bg-active); color: var(--p-color-text); z-index: var(--p-z-index-1); }
...
.Polaris-AlphaTabs__DisclosureActivator:not([aria-disabled='true']):active { background-color: var(--p-color-bg-active); z-index: var(--p-z-index-1); }
...
.Polaris-Tabs__Tab:hover .Polaris-Tabs__Title::before { background-color: var(--p-color-bg-strong-hover); }

.Polaris-Tabs__Tab:active .Polaris-Tabs__Title { background-color: transparent; }

.Polaris-Tabs__Tab:active .Polaris-Tabs__Title::before { background-color: var(--p-color-bg-strong-active); }
