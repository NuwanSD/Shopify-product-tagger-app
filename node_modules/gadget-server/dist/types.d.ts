...
export declare type ActionTrigger = ShopifyWebhookActionTrigger | APIActionTrigger | ShopifySyncActionTrigger | SchedulerActionTrigger | ShopifyOAuthActionTrigger | ShopifyAdminActionTrigger | PlatformTrigger | MockActionTrigger;
export declare type ConfigurationVariablesBlob = Record<string, string | null>;
 ...
 * @property transactional - Whether the action when running the `run` function should be run in a transaction. Defaults to `true`.
